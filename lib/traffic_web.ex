defmodule TrafficWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: TrafficWeb

      import Plug.Conn
      import TrafficWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/traffic_web/templates",
  ...
  defp view_helpers do
    quote do
      ...
      import TrafficWeb.ErrorHelpers
      import TrafficWeb.Gettext
      alias TrafficWeb.Router.Helpers, as: Routes
    end
  end
